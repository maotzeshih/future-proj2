...
def CheckURI(uri, timeout=5):
    ...
    #except Exception as e:
        ...
        #print('Error: GET requst object {}'.format(e))
        return False
...
class Shortener(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        #if "longuri" in params:
        #    longuri = params["longuri"][0]
        #elif "shortname" in params:
        ...
        longuri = params["longuri"][0]
        shortname = params["shortname"][0]                            
        print('\nvalue of longuri={} and shortname={}'.format(longuri, shortname))
        if CheckURI(longuri):
